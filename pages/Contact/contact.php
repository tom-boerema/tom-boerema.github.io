      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu aria-labelledby=navbarDropdown">
            <a class="dropdown-item" href="../sprint-1.html">Sprint 1</a>
            <a class="dropdown-item" href="../sprint-2.html">Sprint 2</a>
		...
		<div class="container-contact1">
			...
			<form method="post" action="contact.php" class="contact1-form validate-form">
				...
				<div class="wrap-input1 validate-input" data-validate = "Subject is required">
					<input class="input1" enctype="text/plain" type="text" name="subject" placeholder="Subject">
					<span class="shadow-input1"></span>
				</div>
